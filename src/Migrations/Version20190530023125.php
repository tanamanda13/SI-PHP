 ...
 */
final class Version20190530023125 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526C39A6B6F6 ON comment');
        ...
        $this->addSql('CREATE INDEX IDX_9474526C39A6B6F6 ON comment (debate_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526C39A6B6F6 ON comment (debate_id_id)');
    }
}
